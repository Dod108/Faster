...
public class MeshDestroy : MonoBehaviour
{
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            if (original.TryGetComponent<FadeOut>(out FadeOut originalFadeOut))
            {
                FadeOut fadeOut = GameObject.AddComponent<FadeOut>();
                fadeOut.finalAlpha = originalFadeOut.finalAlpha;
                fadeOut.distanceFadeStart = originalFadeOut.distanceFadeStart;
                fadeOut.distanceFadeStop = originalFadeOut.distanceFadeStop;
                fadeOut.timeFadeOutRate = originalFadeOut.timeFadeOutRate;
                fadeOut.transparentMaterial = originalFadeOut.transparentMaterial;
